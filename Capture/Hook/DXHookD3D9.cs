...
namespace Capture.Hook
{
    ...
    {
        public DXHookD3D9(CaptureInterface ssInterface) : base(ssInterface) { }

        private Hook<Direct3D9Device_EndSceneDelegate> Direct3DDevice_EndSceneHook = null;
        private Hook<Direct3D9Device_ResetDelegate> Direct3DDevice_ResetHook = null;
        private Hook<Direct3D9Device_PresentDelegate> Direct3DDevice_PresentHook = null;
        private Hook<Direct3D9DeviceEx_PresentExDelegate> Direct3DDeviceEx_PresentExHook = null;
        ...
        private bool _renderTargetCopyLocked = false;
        ...
        private bool _supportsDirect3D9Ex = false;
        ...
        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Unicode, SetLastError = true)]
        private unsafe delegate int Direct3D9Device_PresentDelegate(IntPtr devicePtr, SharpDX.Rectangle* pSourceRect, SharpDX.Rectangle* pDestRect, IntPtr hDestWindowOverride, IntPtr pDirtyRegion);

        [UnmanagedFunctionPointer(CallingConvention.StdCall, CharSet = CharSet.Unicode, SetLastError = true)]
        private unsafe delegate int Direct3D9DeviceEx_PresentExDelegate(IntPtr devicePtr, SharpDX.Rectangle* pSourceRect, SharpDX.Rectangle* pDestRect, IntPtr hDestWindowOverride, IntPtr pDirtyRegion, Present dwFlags);
        ...
        private Capture.Hook.DX9.DXOverlayEngine _overlayEngine;
            ...
            try
            {
                ...
                if (Config.ShowOverlay && displayOverlays != null)
                {
                        ...
                        || IsOverlayUpdatePending)
                    {
                        ...
                        _overlayEngine.Overlays.AddRange(displayOverlays);
