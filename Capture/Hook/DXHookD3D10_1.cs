...
namespace Capture.Hook
{
    ...
    {
        private const int D3D10_1_DEVICE_METHOD_COUNT = 101;

        public DXHookD3D10_1(CaptureInterface ssInterface) : base(ssInterface)
        {
            DebugMessage("Create");
        }

        private List<IntPtr> _d3d10_1VTblAddresses = null;
        ...
        private delegate int DXGISwapChain_PresentDelegate(IntPtr swapChainPtr, int syncInterval, SharpDX.DXGI.PresentFlags flags);
